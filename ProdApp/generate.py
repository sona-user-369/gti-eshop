...
def generate_invoice(pattern):
    ...
    c.drawCentredString(125, 20, "Green Tech Innovation SARL")
    # For under lining the title
    c.line(70, 22, 180, 22)
    # Changing the font size for Specifying Address
    c.setFont("Helvetica-Bold", 5)
    c.drawCentredString(125, 30, "The sense of innovation")
    c.drawCentredString(125, 35, "RCCM: RB/ABC/20 B 3456, Abomey-Calavi, Benin")
    # Changing the font size for Specifying GST Number of firm
    c.setFont("Helvetica-Bold", 6)
    c.drawCentredString(125, 42, "")
    ...
    c.drawCentredString(100, 60, str(
        pattern['ship_option'] + ': {}'.format(pattern['ship_price'] if pattern['ship_price'] is not None else '')))
    ...
    c.drawCentredString(25, 118, "PRODUIT No.")
    c.drawCentredString(75, 118, "DESCRIPTION DU PRODUIT")
    c.drawCentredString(125, 118, "PRIX UNITE")
    c.drawCentredString(148, 118, "QTE")
    ...
    c.drawString(20, 225 + all_length, "Nous attestons que")
    c.drawString(20, 230 + all_length, "les informations mentionnees plus haut sont vraies .")
    c.drawString(20, 235 + all_length, "(Ceci est une facture generé automatiquement)")
...
data_invoice = {'id': 'cpm1',
                'livraison': {'first_name': 'john', 'last_name': 'oke', 'address': '12 street',
                              'phone_number': '123443', 'city': 'Cotonou'},
