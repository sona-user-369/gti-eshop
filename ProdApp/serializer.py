...
class ProduitSerializer(serializers.ModelSerializer):
    class Meta:
        model = Produit
        fields = (
        "nom", "image1", "date_de_stock", "description_courte", "description_longue","additional_info", "stock", "prix", "categorie",
        'sous_categorie')
...
class SousCategorieSerializer(serializers.ModelSerializer):
    ...
    def perform_save(self, validated_data):
        sous_categorie_created = SousCategorie.objects.create(nom=validated_data['nom'],
